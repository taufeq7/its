...
time.sleep(0.1)
mengetik(f"{green}Special thanks to :")
time.sleep(0.1)
...
time.sleep(0.1)
mengetik(f"{cyan}@xtconfig {off}[{green}xans tech config{off}]")
time.sleep(0.1)
mengetik(f"{purple}@nge_gasss {off}[{green}NGE_GASS{off}]")
time.sleep(1)
...
print()
print(f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
print(f"{green}[{yellow}1{green}]{white}TOKEN TAMU       {green}[{yellow}2{green}]{white}TOKEN ITS 48JAM\n{green}[{yellow}3{green}]{white}BILLING UNSRAT")
print(f"————————————————————————————————————————")
...
if inv == '1':
	print()
	print(f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
	print(f"\r{yellow}[{red}info{yellow}]{white}1 TOKEN = 5 USER")
	print(f"\r{yellow}[{red}info{yellow}]{white}gunakan u/ Login pada bagian akses tamu")
	print(f"————————————————————————————————————————")
	print()
	...
	print(end=f"\r{white}Mengambil token tamu...")
	time.sleep(2)
	print(f"\r{green}[{blue}tamu{green}]{yellow}" + individual_words[random_number])
	print(f"{off}")
	print(f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
	print()
	exit(f"{green}[{yellow}✓{green}]{white}Terimakasih telah menggunakan layanan ini\n{green}[{yellow}✓{green}]{white}Pantau terus channel kami\n{green}>> VPNKACANG\n{cyan}>> JSTFREENET\n{yellow}>> FREEDOM'X\n{purple}>> XTC CHANNEL\n{red}>> CHANNEL NGEGASS")
elif inv == '5':
	...
	print(f"{green}[{red}4{green}]{white}xans tech")
	print(f"{green}[{red}5{green}]{white}nge gass")
	...
	if inv == '1':
		...
		os.system(f"xdg-open https://t.me/xtconfig")
	elif inv == '5':
		os.system(f"xdg-open https://t.me/nge_gasss")
elif inv == '6':
	...
	print(f"{green}[{red}4{green}]{white}xanstech channel")
	print(f"{green}[{red}5{green}]{white}nge_gass channel")
	inv = input(f"{purple}>>>{white} Pilih > ")
	if inv == '1':
		...
		os.system(f"xdg-open https://t.me/skuyconfig")
	elif inv == '5':
		os.system(f"xdg-open https://t.me/nge_gazzz")
elif inv == '7':
